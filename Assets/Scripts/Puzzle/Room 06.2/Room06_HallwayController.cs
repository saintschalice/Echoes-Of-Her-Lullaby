...
public class Room06_HallwayController : MonoBehaviour
{
    ...
    [TextArea] public string[] introLines = {
        EnhancedGameDialogues.R06_ENTRY_1,
        EnhancedGameDialogues.R06_ENTRY_2,
        EnhancedGameDialogues.R06_ENTRY_3
    };
    ...
    private IEnumerator ChaseSequence()
    {
        ...
        if (DialogueSystemV2.Instance != null)
        {
            DialogueSystemV2.Instance.StartDialogue(EnhancedGameDialogues.R06_CHASE, "Lisa");
            yield return new WaitForSeconds(0.1f);
